...
if args.k > 0:
    ...
    output_path = "results_bavarian_topk.csv"
...
if os.path.isfile(output_path) == False:
    ...
    out = "graph_name;epsilon;delta;type;m;mctrials;time;estimator;\n"
...
print("time_bavarian",time_bavarian,"samples_bavarian",samples_bavarian)

out_file = open(output_path,"a")
line_out = str(args.db)+";"+str(args.epsilon)+";"+str(args.delta)+";"+str(args.type)+";"+str(samples_bavarian)+";"+str(args.mctrials)+";"+str(time_bavarian)+";"+str(args.approxmode)
line_out = line_out+"\n"
print(line_out)
